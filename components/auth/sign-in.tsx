    ...
    <div className="w-full max-w-md space-y-8">
      ...
      >
        <motion.button
          ...
          className="w-full flex items-center justify-center gap-3 px-6 py-3.5 sm:py-4 bg-[#24292F] hover:bg-[#24292F]/90 text-white rounded-xl transition-all shadow-lg hover:shadow-xl font-medium text-base sm:text-lg"
        >
          <Github className="w-5 h-5 sm:w-6 sm:h-6" />
          <span>Continue with GitHub</span>
          <ArrowRight className="w-4 h-4 sm:w-5 sm:h-5 ml-auto opacity-50" />
        </motion.button>
        ...
        <motion.button
          ...
          className="w-full flex items-center justify-center gap-3 px-6 py-3.5 sm:py-4 bg-white hover:bg-[var(--background)] border border-[var(--text)]/20 text-[var(--text)] rounded-xl transition-all shadow-md hover:shadow-lg font-medium text-base sm:text-lg relative group"
        >
          ...
          <ArrowRight className="w-4 h-4 sm:w-5 sm:h-5 ml-auto opacity-50 text-slate-400 group-hover:text-slate-600" />
        </motion.button>
      </motion.div>
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <input
              ...
              required
              className="w-full pl-12 pr-4 py-3 sm:py-3.5 bg-white border border-[var(--text)]/20 rounded-xl focus:outline-none focus:border-[var(--primary)] focus:ring-2 focus:ring-[var(--primary)]/20 transition-all font-medium text-[var(--text)] placeholder:text-[var(--text)]/40 shadow-sm text-sm sm:text-base"
            />
          </div>
        </div>
        <Button
